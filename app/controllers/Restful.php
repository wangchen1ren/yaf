 ...
 *
 * Restful controller helps to easy create crud actions for a model.
 * Assuming that the Controller has the same name with your model. If you have 
 * a PostsController then Restful controller will assume that your resource is 
 * the PostModel. 
 *
 * Notice that controller name is defined as `Posts`, plural, and model is 
 * defind as `Post` singular. RestfulController uses Inflect class to 
 * determinate the name of the Model to load {@link get_model_name()}
 *
 */
abstract class RestfulController extends ApplicationController
{
    private $_resource;
